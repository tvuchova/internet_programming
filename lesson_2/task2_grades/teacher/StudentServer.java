package lesson_2.task2_grades.teacher;
...
import static lesson_2.task2_grades.teacher.LoggerConfig.configureLogger;


public class StudentServer {
    private static final Logger LOGGER = Logger.getLogger(StudentServer.class.getName());
    private static final int MAX_CLIENTS = 5;  // Limit the number of clients
