package org.lecture.servlet.teacher;
...
public class UserServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        // Track page visits with HttpSession
        ...
        response.getWriter().println("<p>You have visited " + visitCount + " times.</p>");
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        log.info("Cookies: " + cookies[0].getName() + " " + cookies[0].getValue());

        // Retrieve username from cookies if available
        if (cookies != null) {
